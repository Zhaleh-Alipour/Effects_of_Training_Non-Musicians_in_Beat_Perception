...
# Auditoryy Training Experiment
In this experiment, we had two auditory trainning groups. The file `AudTraining2.psyexp` ccorresponds to the **second auditory training group**.
...
# Uploading and Running the Experiment
    ...
    - Push the changes to GitHub using the ![alt text](image.png) button and filling the commit message and description as needed. 
